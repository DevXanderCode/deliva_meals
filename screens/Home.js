      ...
      <TouchableOpacity
        ...
        <View style={{marginBottom: SIZES?.padding}}>
          <Image
            source={item?.photo}
            resizeMode="cover"
            style={styles?.restaurantListImg}
          />

          <View style={[styles?.restaurantListTextContainer, styles?.shadow]}>
